      ...
      <View className='flex flex-col items-center justify-center p-3'>
        ...
        <View className='flex flex-row items-center justify-between'>
            ...
            <View className='flex flex-col mx-5 gap-y-5 flex-1'>
                ...
                <View className='flex flex-row items-center gap-x-2'>
                    ...
                    <Text className='font-JakartaMedium text-base' numberOfLines={1}>{origin_address}</Text>
                ...
                <View className='flex flex-row items-center gap-x-2'>
                    ...
                    <Text className='font-JakartaMedium text-base'>{destination_address}</Text>
        ...
        <View className='flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 items-center justify-center'>
            ...
            <View className='flex flex-row items-center w-full justify-between mb-5'>
                ...
                <Text className='text-base font-JakartaMedium text-gray-500'>{driver.first_name} {driver.last_name}</Text>
